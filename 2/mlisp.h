...
inline double remainder(double x, double y) { return std::fmod(x, y); }
inline double quotient(double x, double y) { return std::floor(x / y); }
inline double expt(double x, double y) { return std::pow(x, y); }
